...
// ===== ドライバ選択マクロ =====
// ビルド時に -DTFT_DRIVER_ST7735S または -DTFT_DRIVER_ST7789V を指定する想定
//#define TFT_DRIVER_ST7735S
#define TFT_DRIVER_ST7789V

#if defined(TFT_DRIVER_ST7735S)

// ★いま使っている ST7735S 160x80 用
...
#else
#error "TFT_DRIVER_ST7735S または TFT_DRIVER_ST7789V を define してください"
#endif

// Define screen resolution and offset
//#define ST7735_WIDTH    160
//#define ST7735_HEIGHT   80
//#define ST7735_X_OFFSET 0               // 20250116 1  -> 0
//#define ST7735_Y_OFFSET 24              // 20250116 26 -> 25

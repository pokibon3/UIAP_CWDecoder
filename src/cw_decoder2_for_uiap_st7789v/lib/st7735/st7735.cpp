...
#elif defined(TFT_DRIVER_ST7789V)
    // ★ST7789V 用のシンプル初期化例
 //   write_command_8(0x01);    // software reset 0x01
 //   Delay_Ms(150);
    // 7789 も SLPIN/SLPOUT, MADCTL, COLMOD, DISPON のコマンド値は同じなので流用できる
    write_command_8(ST7735_SLPOUT); // sleep out 0x11
    Delay_Ms(255);

    // 16bit/pixel
    write_command_8(ST7735_COLMOD); //     0x3a
    //write_data_8(ST7735_COLMOD_16_BPP);
    write_data_8(0x55);
    Delay_Ms(10);

    // 向き（必要に応じて調整）
    write_command_8(ST7735_MADCTL); // 0x36
...
//    write_command_8(0x2a);  // CASET
//    write_data_8(0x00);
//    write_data_8(0x00);
//    write_data_8(0x00);
//    write_data_8(0xf0);
//    Delay_Ms(10);
//    write_command_8(0x2b);  // RASET
//    write_data_8(0x00);
//    write_data_8(0x28);
//    write_data_8(0x00);
//    // write_data_8(175);
//    Delay_Ms(10);
    ...
    // 必要なら ST7789V 用の電源・ガンマをここに追加
    // 例:
    // write_command_8(0xB2); ... // PORCTRL
    // write_command_8(0xBB); ... // VCOMS
    // write_command_8(0xE0); ... // GCTRL など

    write_command_8(ST7735_INVON); // or INVOFF 0x21
    Delay_Ms(10);
//    write_command_8(ST7735_NORON);  // 0x13
//    Delay_Ms(10);
    write_command_8(ST7735_DISPON); // 0x29
    Delay_Ms(10);
#endif
    END_WRITE();
}

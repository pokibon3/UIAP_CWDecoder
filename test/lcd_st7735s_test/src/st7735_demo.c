/// \brief ST7735 Driver for CH32V203 - Demo
///
/// \author Li Mingjie
...
/// |                | 2 - GND   | GND   | GND                               |
/// | PA6            | 3 - RESET |       | Reset                             |
/// | PA4            | 4 - RS    |       | DC (Data / Command)               |
/// | PA7 (SPI MOSI) | 5 - SDA   |       | SPI MOSI (Master Output Slave In) |
/// | PA5 (SPI SCLK) | 6 - SCL   |       | SPI SCLK (Serial Clock)           |
/// |                | 7 - VDD   | 3V3   | VDD                               |
/// | PA3            | 8 - CS    |       | SPI CS/SS (Chip/Slave Select)     |
...
/*
    tft_draw_pixel(0, 0, WHITE);
    tft_draw_pixel(159, 0, WHITE);
    tft_draw_pixel(0, 79, WHITE);
    tft_draw_pixel(159, 79, WHITE);
    tft_draw_line(0, 0, 159, 0, BLUE);
    tft_draw_line(159, 0, 159, 79, RED);
    tft_draw_line(159, 79, 0, 79, YELLOW);
    tft_draw_line(0, 79, 0, 0, WHITE);
    Delay_Ms(1000);
*/
    while (1)
    {
